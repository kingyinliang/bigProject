...
if (type === undefined) {
  ...
  switch (type) {
    ...
    case 'test':
      ...
      // HOST = 'http://ALB002-ECS-1150488715.cn-north-1.elb.amazonaws.com.cn/xhqy-fc'
      break
    case 'pro':
      HOST = 'https://apimarket.shinho.net.cn/xhqy-fc'
      // HOST = 'http://internal-ALB003-Shinho-Micro-PRD-929565893.cn-north-1.elb.amazonaws.com.cn/xhqy-fc'
      break
    default:
      HOST = 'https://apimarket-dev.shinho.net.cn/xhqy-fc'
      // HOST = 'http://ALB001-ECS-1995142321.cn-north-1.elb.amazonaws.com.cn/xhqy-fc'
