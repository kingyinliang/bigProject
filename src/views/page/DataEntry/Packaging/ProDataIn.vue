                ...
                <el-table
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                      ...
                      <el-button type="text" size="small" @click="dayLaborer(scope.row)" v-if="scope.row.userType=='临时工' && isRedact">点击输入临时工</el-button>
                    </template>
                  </el-table-column>
                  <el-table-column
                    label="开始时间">
          ...
          <el-tab-pane name="5">
            ...
            <el-table
              ...
              <el-table-column
                label="批次">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.batch" v-if="isRedact"></el-input>
