          ...
          <el-row type="flex" style="border-bottom:1px solid #E9E9E9;margin-bottom:12px">
            ...
            <el-col style="width:340px">
              <el-row class="rowButton">
                <el-button type="primary" size="small" @click="alert(2)" style="float:right" >导出</el-button>
                <el-button type="primary" size="small" @click="alert(1)" style="float:right" >查询</el-button>
              </el-row>
            </el-col>
          </el-row>
        </el-card>
